                                    ...
                                    <div class="table-responsive">
                                        <table id="zones-table" class="table table-hover table-bordered"
                                            ...
                                            <tr>
                                                ...
                                                <th class="w-10 text-center">PDF</th>
                                            ...
                                            <tr v-for="zone in zonesFloors.zones">
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <zone-observations @refreshData="loadData()" :zone-id="zone.hashid"
                                                                       :zone-name="zone.name"
                                                                       :zone-observations="zone.observations">
                                                    </zone-observations>
                                                </td>
                                            </tr>
                                            </tbody>
...
<script>
    ...
    import ZoneObservations from './ZoneObservations';
    ...
    export default {
        ...
        components: {
            ...
            'zone-observations': ZoneObservations
        },
        data() {
            return {
                isSaving: false,
