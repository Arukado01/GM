<template>
    <div>
        <div class="row">
            <div class="col-md-12">
                <div id="pdf-upload-esp-tec" class="dropzone text-center"></div>
            </div>
        </div>
                    ...
                    <div class="card-header">
                        <h5>
                            <a :href="urlImage" target="_blank">
                                Especificaciones Técnicas de Construcción ({{ pProjectName }}) <i class="fa fa-external-link"></i>
                            </a>
                        </h5>
                    </div>
                </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            if (document.getElementById('pdf-upload-esp-tec')) {
                this.initDropZone();
            }
        },
        methods: {
            initDropZone() {
                let vm = this;
                this.pdfDropzone = new Dropzone("div#pdf-upload-esp-tec", {
                    url: vm.pUrl,
                    maxFiles: 1,
                    timeout: 240000,
