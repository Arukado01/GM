<template>
    <div>
        <div class="row">
            <div class="col-md-12">
                <div id="pdf-upload-quality-plan" class="dropzone text-center"></div>
            </div>
        </div>
                    ...
                    <div class="card-header">
                        <h5>
                            <a :href="urlImage" target="_blank">
                                Plan de Calidad ({{ pProjectName }}) <i class="fa fa-external-link"></i>
                            </a>
                        </h5>
                    </div>
                </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            if (document.getElementById('pdf-upload-quality-plan')) {
                this.initDropZone();
            }
        },
        methods: {
            initDropZone() {
                let vm = this;
                this.pdfDropzone = new Dropzone("div#pdf-upload-quality-plan", {
                    url: vm.pUrl,
                    maxFiles: 1,
                    timeout: 240000,
