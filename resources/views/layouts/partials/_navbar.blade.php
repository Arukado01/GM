<nav class="site-navbar navbar fixed-top navbar-toggleable-md navbar-inverse bg-indigo-500">
    ...
    <div class="navbar-header">
        <a href="{{ route('home') }}" class="navbar-brand">
            ...
            <span class="brand-name hidden-fold">
                Proyectos S.A.S
            </span>
        </a>
        <button data-toggle="menubar" class="mr-auto hidden-lg-up hamburger hamburger--collapse js-hamburger"
                type="button">
            <span class="hamburger-box">
                <span class="hamburger-inner"></span>
            </span>
        </button>
        <button type="button" class="navbar-toggler hidden-lg-up collapsed" data-toggle="collapse"
